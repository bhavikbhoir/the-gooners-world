...
import ARSTOT from '../assets/ARSTOT.jpg';

export default class Fixtures extends Component {
    btnClick() {
        window.open("https://youtu.be/ieAj3Emg7lg");
    }
    detailsbtnClick() {
                ...
                <Row> 
                    <Col lg={6} md={12} sm={12}>
                        ...
                        <p style={{textAlign: "left", fontSize: "1.125rem"}}>
                            ...
                            <br/>
                            <br/>
                            <i>We play Olympiacos next in the second leg of our Round of 16 Europa League clash.</i>
                        </p>
                    </Col>
                    ...
                    /> */}
                    <img src={ARSTOT} alt="Gunners celebrating Arsenal's second goal against Spurs."/>
                    <caption>Gunners celebrating Arsenal's second goal against Spurs. (Source: Arsenal.com)</caption>
                    </Col>
